...
!function(a) {
    ...
    a.validator.addMethod("cpfBR", function(a) {
        ...
        11 !== a.length)
            return !1;
        var b, c, d, e, f = 0;
        if (b = parseInt(a.substring(9, 10), 10),
    ...
    a.validator.addMethod("creditcardtypes", function(a, b, c) {
        ...
        c.unknown && (d |= 128),
        c.all && (d = 255),
        1 & d && /^(5[12345])/.test(a) ? 16 === a.length : 2 & d && /^(4)/.test(a) ? 16 === a.length : 4 & d && /^(3[47])/.test(a) ? 15 === a.length : 8 & d && /^(3(0[012345]|[68]))/.test(a) ? 14 === a.length : 16 & d && /^(2(014|149))/.test(a) ? 15 === a.length : 32 & d && /^(6011)/.test(a) ? 16 === a.length : 64 & d && /^(3)/.test(a) ? 16 === a.length : 64 & d && /^(2131|1800)/.test(a) ? 15 === a.length : !!(128 & d)
    }, "Please enter a valid credit card number."),
